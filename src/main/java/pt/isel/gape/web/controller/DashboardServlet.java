...
public final class DashboardServlet extends HttpServlet {
    ...
    DashboardServlet(SessionService sessionService, SessionManager sessionManager) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.sendRedirect(request.getContextPath() + resolveLandingPage(sessionUser.get()));
    }
