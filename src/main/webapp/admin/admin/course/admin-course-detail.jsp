                ...
                <c:if test="${not course.archived and canModifyCourse}">
                    <div class="bg-white rounded-10 px-24 py-24">
                        ...
                        <div class="d-flex align-items-center gap-16 flex-wrap">
                            <button type="button" class="gape-action-button gape-action-archive px-24 py-12 rounded-12 fw-semibold transition-03" data-bs-toggle="modal" data-bs-target="#archiveCourse">Deactivate</button>
