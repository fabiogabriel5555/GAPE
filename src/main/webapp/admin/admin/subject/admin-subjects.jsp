                ...
                <div class="bg-white rounded-10 px-24 py-24">
                    <div class="d-flex align-items-center justify-content-between gap-16 flex-wrap mb-20">
                        ...
                        <c:if test="${canCreateSubjects}">
                            <a href="${pageContext.request.contextPath}/admin/subjects/new" class="bg-main-600 px-24 py-12 rounded-12 fw-semibold text-white hover-bg-main-700 transition-03">
                                ...
                                <tr class="hover-bg-neutral-20 border-bottom transition-03">
                                    ...
                                    <td class="py-20 px-20">
                                        <div class="d-flex align-items-center gap-12 justify-content-end">
                                            <a href="${pageContext.request.contextPath}/admin/subjects/${subject.id}" class="text-22 text-neutral-500 hover-text-main-600" title="Detail">
                                                <i class="ph ph-eye"></i>
                                            </a>
                                            <c:if test="${not subject.archived and canModifySubjectRow}">
                                                <a href="${pageContext.request.contextPath}/admin/subjects/${subject.id}/edit" class="text-22 text-neutral-500 hover-text-main-600" title="Edit">
                                                    <i class="ph ph-pencil-simple-line"></i>
                                                </a>
                                                <a href="${pageContext.request.contextPath}/admin/subjects/${subject.id}/courses" class="text-22 text-neutral-500 hover-text-main-600" title="Associate courses">
