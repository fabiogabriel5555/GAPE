...
<head>
    ...
    <title>GAPE - Associate Courses</title>
                            ...
                            <form action="${pageContext.request.contextPath}/admin/subjects/${subject.id}/courses/${association.courseId}" method="post" class="gape-association-form border border-neutral-30 rounded-12 px-20 py-20">
                                ...
                                <div class="row gy-4 align-items-start">
                                    ...
                                    <div class="col-xl-2 col-lg-3 col-md-6">
                                        <label for="curricularYear${association.courseId}" class="fw-medium text-base text-neutral-800 mb-12">Year</label>
                                        <input id="curricularYear${association.courseId}" name="curricularYear" type="number" min="1" value="<c:out value='${association.curricularYear}'/>" class="form-control px-24 py-14 fw-normal text-14 text-neutral-700 bg-neutral-20 border-neutral-30 border rounded-14 focus-visible-outline focus-border-main-600">
                                    </div>
                                    <div class="col-xl-2 col-lg-3 col-md-6 gape-select-field">
                                        <label for="term${association.courseId}" class="fw-medium text-base text-neutral-800 mb-12">Period</label>
                                        <select id="term${association.courseId}" name="term" class="form-select px-24 py-14 text-14 bg-neutral-20 border-neutral-30 border rounded-14 js-example-basic-single gape-eduall-select">
                                    ...
                                    <div class="col-xl-2 col-lg-3 col-md-6 gape-select-field">
                                        <label for="state${association.courseId}" class="fw-medium text-base text-neutral-800 mb-12">State</label>
                                        <select id="state${association.courseId}" name="state" class="form-select px-24 py-14 text-14 bg-neutral-20 border-neutral-30 border rounded-14 js-example-basic-single gape-eduall-select">
                                    ...
                                    <div class="col-xl-2 col-lg-6">
                                        ...
                                        <div class="form-check common-check gape-association-check mb-0">
                                            <input class="form-check-input" type="checkbox" id="mandatory${association.courseId}" name="mandatory" value="true" ${association.mandatory ? 'checked' : ''}>
