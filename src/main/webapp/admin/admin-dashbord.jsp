...
<head>
    ...
    <!-- Main css -->
    <link rel="stylesheet" href="assets/css/main.css?v=20260715-sidebar-corner-3">
</head>
<body>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="hover-bg-neutral-20 border-bottom transition-03">
                                            <td class="py-22 line-height-1 px-20 shadow-none">
                                                <div class="d-flex align-items-center gap-12">
                                                    <a href="javascript:void(0)" aria-label="View Vuejs course">
                                        ...
                                        <tr class="hover-bg-neutral-20 border-bottom transition-03">
                                            <td class="py-22 line-height-1 px-20 shadow-none">
                                                <div class="d-flex align-items-center gap-12">
                                                    <a href="javascript:void(0)" aria-label="View Swift course">
                                        ...
                                        <tr class="hover-bg-neutral-20 border-bottom transition-03">
                                            <td class="py-22 line-height-1 px-20 shadow-none">
                                                <div class="d-flex align-items-center gap-12">
                                                    <a href="javascript:void(0)" aria-label="View Objective C course">
                                        ...
                                        <tr class="hover-bg-neutral-20 border-bottom transition-03">
                                            <td class="py-22 line-height-1 px-20 shadow-none">
                                                <div class="d-flex align-items-center gap-12">
                                                    <a href="javascript:void(0)" aria-label="View NodeJS course">
                                        ...
                                        <tr class="hover-bg-neutral-20 border-bottom transition-03">
                                            <td class="py-22 line-height-1 px-20 shadow-none">
                                                <div class="d-flex align-items-center gap-12">
                                                    <a href="javascript:void(0)" aria-label="View CSS3 course">
                                        ...
                                        <tr class="hover-bg-neutral-20 border-bottom transition-03">
                                            <td class="py-22 line-height-1 px-20 shadow-none">
                                                <div class="d-flex align-items-center gap-12">
                                                    <a href="javascript:void(0)" aria-label="View Angular course">
                                        ...
                                        <tr class="hover-bg-neutral-20 border-neutral-25 border-bottom transition-03">
                                            <td class="py-22 line-height-1 px-20 shadow-none">
                                                <div class="d-flex align-items-center gap-12">
                                                    <a href="javascript:void(0)" aria-label="View Jango course">
                                ...
                                <tbody>
                                    ...
                                    <tr class="hover-bg-neutral-20 border-bottom transition-03">
                                        <td class="py-20 px-20 shadow-none line-height-1">
                                            <div class="d-flex align-items-center gap-12">
                                                <a href="javascript:void(0)" class="flex-shrink-0" aria-label="Open notification">
                                ...
                                <table id="example-four" class="display min-w-max">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="hover-bg-neutral-20 border-bottom transition-03">
                                            <td class="py-20 px-20 shadow-none line-height-1">
                                                <div class="d-flex align-items-center gap-12">
                                                    <a href="javascript:void(0)" class="flex-shrink-0" aria-label="Open notice">
