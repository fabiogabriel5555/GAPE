...
<head>
    ...
    <!-- Title -->
    <title>GAPE - Privacy Policy</title>
    <!-- Favicon -->
            ...
            <div class="row gy-4">
                <div class="col-lg-8">
                    <div class="d-flex flex-column gap-40">
                        <div class="">
                            ...
                            <p class="text-neutral-700">Thank you for choosing GAPE! Your privacy is important to us, and we are committed to protecting your personal information. This Privacy Policy explains how GAPE collects, uses, discloses, and safeguards your information when you use our education and online course platform, including any community features.</p>
                        </div>
                        <div class="">
                ...
                <div class="col-lg-4">
                    <div class="border border-neutral-30 rounded-12 bg-main-25 p-32 bg-main-25">
                        ...
                        <span class="d-block border border-neutral-30 my-24 border-dashed"></span>
                        <a href="sign-in.jsp" class="h6 mb-0 text-main-600 fw-semibold hover-text-decoration-underline">
                            See All
