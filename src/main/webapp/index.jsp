    ...
    <li class="nav-menu__item">
        <a href="contact.jsp" class="nav-menu__link">Contact</a>
            ...
            <div class="header-right flex-align">
                ...
                <a href="sign-in.jsp" class="info-action w-52 h-52 bg-main-25 hover-bg-main-600 border border-neutral-30 rounded-circle flex-center text-2xl text-neutral-500 hover-text-white hover-border-main-600">
            ...
            <div class="col-xl-6">
                <div class="banner-content pe-md-4">
                    ...
                    <div class="buttons-wrapper flex-align flex-wrap gap-24 mt-40">
                        <a href="course.jsp" class="btn btn-main rounded-pill flex-align gap-8" data-aos="fade-right">
                            Browse Courses
                            <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
                        </a>
                        <a href="about-four.jsp" class="btn btn-outline-main rounded-pill flex-align gap-8" data-aos="fade-left">
                            About Us
                            <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
                        </a>
                    </div>
        ...
        <div class="features-slider">
            <div class="px-8" data-aos="zoom-in" data-aos-duration="400">
                <div class="features-item item-hover animation-item bg-main-25 border border-neutral-30 rounded-16 transition-1 hover-bg-main-600 hover-border-main-600">
                    ...
                    <a href="course-list-view.jsp" class="item-hover__text flex-align gap-8 text-main-600 mt-24 hover-text-decoration-underline transition-1">
                        View Category
    ...
    <div class="container">
        <div class="section-heading text-center style-flex gap-24">
            ...
            <div class="section-heading__content">
                ...
                <a href="course-list-view.jsp" class="item-hover__text flex-align gap-8 text-main-600 mt-24 hover-text-decoration-underline transition-1" tabindex="0">
                    See All Course
                    <i class="ph ph-arrow-right"></i>
                </a>
            </div>
                    ...
                    <div class="about-content">
                        <div class="mb-40">
                            <div class="flex-align gap-8 mb-16 wow bounceInDown">
                                <span class="w-8 h-8 bg-main-600 rounded-circle"></span>
                                <h5 class="text-main-600 mb-0 ">About GAPE</h5>
                            </div>
        ...
        <div class="col-xl-6">
            <div class="choose-us__content">
                ...
                <div class="pt-24 border-top border-neutral-50 mt-28 border-dashed border-0">
                    <a href="about-four.jsp" class="btn btn-main rounded-pill flex-align d-inline-flex gap-8">
                        Read More
                        <i class="ph-bold ph-arrow-up-right d-flex text-lg"></i>
                    </a>
                </div>
            ...
            <div class="col-lg-6">
                <div class="testimonials__content">
                    <div class="section-heading style-left">
                        ...
                        <h2 class="mb-24 wow bounceIn">Testimonials from Happy Learners for GAPE</h2>
                        <p class="text-neutral-500 text-line-2 wow bounceInUp">16+ million Students are already learning on GAPE Platform</p>
                    </div>
                    ...
                    <div class="testimonials__slider">
                        <div class="testimonials-item">
                            ...
                            <p class="text-neutral-700" data-aos="fade-left" data-aos-duration="1200">"Enrolling in courses at GAPE was one of the best decisions I've made for my career. The flexibility of the online learning platform allowed me to study at my own pace while balancing my workâ€</p>
                        ...
                        <div class="testimonials-item">
                            ...
                            <p class="text-neutral-700" data-aos="fade-left" data-aos-duration="1200">"Signing up for courses at GAPE was quite possibly of the best choice I've made for my vocation. The adaptability of the internet learning stage permitted me to learn at my own speed while adjusting my work"</p>
            ...
            <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-sm-2 row-cols-1 gy-5">
                <div class="col" data-aos="fade-up" data-aos-duration="300" >
                    <div class="footer-item">
                        ...
                        <p class="my-32">GAPE exceeded all my expectations! The instructors were not only experts</p>
                ...
                <div class="col" data-aos="fade-up" data-aos-duration="400" >
                    <div class="footer-item">
                        ...
                        <ul class="footer-menu">
                            <li class="mb-16">
                                <a href="about-four.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">About us</a>
                            </li>
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">Courses</a>
                            </li>
                            <li class="mb-16">
                                <a href="instructor.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">Instructor</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col" data-aos="fade-up" data-aos-duration="600" >
                    <div class="footer-item">
                        ...
                        <ul class="footer-menu">
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">UI/UX Design</a>
                            </li>
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">Web Development</a>
                            </li>
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">Python Development</a>
                            </li>
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">Digital Marketing</a>
                            </li>
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">Graphic Design</a>
                            </li>
                        </ul>
                    </div>
                </div>
