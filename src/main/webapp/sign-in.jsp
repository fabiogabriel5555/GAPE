                ...
                <div class="col-lg-6">
                    <div class="bg-main-25 border border-neutral-30 rounded-8 p-32">
                        ...
                        <c:if test="${param.auth eq 'expired'}">
                            <div class="alert alert-warning rounded-8 mb-24" role="alert">A sessao expirou por inatividade.</div>
                        </c:if>
                        <c:if test="${param.auth eq 'required'}">
                            <div class="alert alert-warning rounded-8 mb-24" role="alert">Tem de iniciar sessao para aceder a essa pagina.</div>
                        </c:if>
                        <c:if test="${param.auth eq 'missing' or param.auth eq 'invalid'}">
                            <div class="alert alert-warning rounded-8 mb-24" role="alert">A sessao atual ja nao e valida.</div>
                        </c:if>
                        <c:if test="${param.logout eq '1'}">
                            <div class="alert alert-success rounded-8 mb-24" role="alert">Sessao terminada com sucesso.</div>
                        </c:if>
