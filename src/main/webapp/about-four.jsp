                ...
                <div class="col-xl-6">
                    <div class="about-two-content">
                        <div class="mb-40">
                            ...
                            <p class="text-neutral-500 text-line-2 wow bounceInUp">If teaching jobs interests you, then you are on the right place. GAPE, we often haveÂ 500+Â open home tuition jobs that are genuine andÂ 100%Â verified.</p>
                        </div>
            ...
            <div>
                <div class="scale-hover-item bg-white rounded-16 p-12 h-100 border border-neutral-20">
                    <div class="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative">
                        <a href="tutor-details.jsp" class="w-100 h-100">
                    ...
                    <div class="pt-32 pb-24 px-16 position-relative">
                        <div class="">
                            <h4 class="mb-16">
                                <a href="tutor-details.jsp" class="link text-line-2">Ronald Richards</a>
                            </h4>
                        ...
                        <div class="flex-between gap-8 pt-24 border-top border-neutral-50 mt-24 border-dashed border-0">
                            <a href="contact.jsp" class="flex-align gap-8 text-main-600 hover-text-decoration-underline transition-1 fw-semibold" tabindex="0">
                                Apply Now
            ...
            <div>
                <div class="scale-hover-item bg-white rounded-16 p-12 h-100 border border-neutral-20">
                    ...
                    <div class="pt-32 pb-24 px-16 position-relative">
                        <div class="">
                            <h4 class="mb-16">
                                <a href="tutor-details.jsp" class="link text-line-2">Jacob Jones</a>
                            </h4>
                            <div class="flex-between gap-8 flex-wrap">
                                <div class="flex-align gap-12">
                                    <span class="text-2xl text-main-600 d-flex"><i class="ph-bold ph-graduation-cap"></i></span>
            ...
            <div>
                <div class="scale-hover-item bg-white rounded-16 p-12 h-100 border border-neutral-20">
                    ...
                    <div class="pt-32 pb-24 px-16 position-relative">
                        <div class="">
                            <h4 class="mb-16">
                                <a href="tutor-details.jsp" class="link text-line-2">Darlene Robertson</a>
                            </h4>
                            <div class="flex-between gap-8 flex-wrap">
                                <div class="flex-align gap-12">
                                    <span class="text-2xl text-main-600 d-flex"><i class="ph-bold ph-graduation-cap"></i></span>
            ...
            <div>
                <div class="scale-hover-item bg-white rounded-16 p-12 h-100 border border-neutral-20">
                    ...
                    <div class="pt-32 pb-24 px-16 position-relative">
                        <div class="">
                            <h4 class="mb-16">
                                <a href="tutor-details.jsp" class="link text-line-2">Esther Howard</a>
                            </h4>
                            <div class="flex-between gap-8 flex-wrap">
                                <div class="flex-align gap-12">
                                    <span class="text-2xl text-main-600 d-flex"><i class="ph-bold ph-graduation-cap"></i></span>
            ...
            <div class="row gy-5">
                <div class="col-lg-3 col-sm-6 col-xs-6"  data-aos="fade-up" data-aos-duration="400">
                    <div class="footer-item">
                        ...
                        <ul class="footer-menu">
                            <li class="mb-16">
                                <a href="about-four.jsp" class="text-white hover-text-main-600 hover-text-decoration-underline">About us</a>
                            </li>
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-white hover-text-main-600 hover-text-decoration-underline">Courses</a>
                            </li>
                            <li class="mb-16">
                                <a href="instructor.jsp" class="text-white hover-text-main-600 hover-text-decoration-underline">Instructor</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-xs-6"  data-aos="fade-up" data-aos-duration="600">
                    <div class="footer-item">
                        ...
                        <ul class="footer-menu">
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-white hover-text-main-600 hover-text-decoration-underline">UI/UX Design</a>
                            </li>
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-white hover-text-main-600 hover-text-decoration-underline">Web Development</a>
                            </li>
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-white hover-text-main-600 hover-text-decoration-underline">Python Development</a>
                            </li>
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-white hover-text-main-600 hover-text-decoration-underline">Digital Marketing</a>
                            </li>
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-white hover-text-main-600 hover-text-decoration-underline">Graphic Design</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container container-two">
                <div class="bottom-footer__inner flex-between gap-16 flex-wrap">
                    <div class="footer-item__logo mb-0"  data-aos="zoom-in-right">
                        <a href="index.jsp"> <img src="assets/images/logo/logo-white.png" alt=""></a>
                    </div>
                    <p class="text-white text-line-1 fw-normal"  data-aos="zoom-in"> Copyright &copy; 2024 <span class="fw-semibold">GAPE</span> All Rights Reserved.</p>
