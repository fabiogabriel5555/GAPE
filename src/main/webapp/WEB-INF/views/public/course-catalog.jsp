...
<header class="header bg-white border-bottom border-neutral-30">
    <div class="container container--xl">
        <nav class="header-inner flex-between gap-8">
            <a href="${pageContext.request.contextPath}/login.jsp" class="link">
                <img src="${pageContext.request.contextPath}/assets/images/logo/logo.svg" alt="GAPE">
            </a>
            <div class="header-menu d-lg-block d-none">
                <ul class="nav-menu flex-align">
                    <li class="nav-menu__item"><a href="${pageContext.request.contextPath}/login.jsp" class="nav-menu__link">Home</a></li>
                    <li class="nav-menu__item activePage"><a href="${pageContext.request.contextPath}/courses" class="nav-menu__link">Courses</a></li>
                    <li class="nav-menu__item"><a href="${pageContext.request.contextPath}/login.jsp" class="nav-menu__link">Contact</a></li>
                </ul>
            </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                        <div class="course-item__thumb rounded-12 overflow-hidden">
                            <a href="${pageContext.request.contextPath}/courses/${course.id}" class="w-100 h-100" aria-label="Open course details">
                                <c:choose>
