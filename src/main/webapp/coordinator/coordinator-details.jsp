...
<head>
    ...
    <!-- Title -->
    <title>GAPE - Coordinator Details</title>
    <!-- Favicon -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="breadcrumb__wrapper">
                    <h1 class="breadcrumb__title display-4 fw-semibold text-center"> Coordinators Details</h1>
                    <ul class="breadcrumb__list d-flex align-items-center justify-content-center gap-4">
                        ...
                        <li class="breadcrumb__item">
                            <span class="text-main-two-600"> Coordinators Details </span>
                        </li>
                    </ul>
                </div>
            </div>
...
<!-- ==================== Breadcrumb End Here ==================== -->
    ...
    <!-- ================================ Coordinator Details Section Start ==================================== -->
    <section class="coordinator-details py-120 position-relative z-1">
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-4">
                    <div class="coordinator-details__thumb">
                ...
                <div class="col-lg-8 ps-xl-5">
                    <div class="ps-lg-5">
                        <h5 class="text-main-600 mb-0">Coordinator</h5>
                        <h2 class="my-16">Robert Fox</h2>
                        <span class="text-neutral-700">Developer And Coordinator</span>
                        ...
                        <p class="text-neutral-500">Offer brief biographies or profiles of each coordinator. These may include details about their careers, achievements, and interests.</p>
                        <span class="d-block border border-neutral-30 my-40 border-dashed"></span>
    ...
    <!-- ================================ Coordinator Details Section End ==================================== -->
