...
<head>
    ...
    <!-- Title -->
    <title>GAPE - Lesson Details</title>
    <!-- Favicon -->
                                ...
                                <div class="accordion-body p-0 bg-main-25">
                                    <div class="curriculam-item">
                                        ...
                                        <div class="flex-between gap-8 mt-24">
                                            <a href="lesson-details.jsp" class="flex-align gap-8 text-main-600 hover-text-decoration-underline transition-1 fw-semibold" tabindex="0">
                                                View Profile
