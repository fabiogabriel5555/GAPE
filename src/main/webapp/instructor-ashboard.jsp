...
<head>
    ...
    <!-- Title -->
    <title>GAPE - Instructor Ashboard</title>
    <!-- Favicon -->
    ...
    <li class="nav-menu__item has-submenu">
        <a href="javascript:void(0)" class="nav-menu__link">Dashboard</a>
         <ul class="nav-submenu scroll-sm">
            ...
            <li class="nav-submenu__item">
                <a href="student-dashbord-my-profile.jsp" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord My Profile</a>
            </li>
            <li class="nav-submenu__item">
                <a href="student-dashbord-message.jsp" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Message</a>
            </li>
            <li class="nav-submenu__item">
                <a href="student-dashbord-enrolled-courses.jsp" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Enrolled Courses</a>
            </li>
            <li class="nav-submenu__item">
                <a href="student-dashbord-wishlist.jsp" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Wishlist</a>
            </li>
            <li class="nav-submenu__item">
                <a href="student-dashbord-reviews.jsp" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Reviews</a>
            </li>
            <li class="nav-submenu__item">
                <a href="student-dashbord-my-quiz-attempts.jsp" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord My Quiz Attempts</a>
            </li>
            <li class="nav-submenu__item">
                <a href="student-dashbord-assignment.jsp" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Assignment</a>
            </li>
            <li class="nav-submenu__item">
                <a href="student-dashbord-settings.jsp" class="nav-submenu__link hover-bg-neutral-30">Student Dashbord Settings</a>
            </li>
        </ul>
    </li>
