...
<head>
    ...
    <!-- Title -->
    <title>GAPE - Instructor My Profile</title>
    <!-- Favicon -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="breadcrumb__wrapper">
                    <h1 class="breadcrumb__title display-4 fw-semibold text-center"> instructor my profile</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="bg-main-25 border border-neutral-30 rounded-16 p-40 text-center">
                        ...
                        <h3 class="mb-16 text-neutral-500">instructor my profile</h3>
                        ...
                        <div class="d-flex justify-content-center gap-16 flex-wrap">
                            ...
                            <a href="dashboard.jsp" class="btn btn-outline-main rounded-pill">Abrir dashboard</a>
                        </div>
                    </div>
                </div>
            </div>
