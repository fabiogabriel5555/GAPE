            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="bg-main-25 border border-neutral-30 rounded-16 p-40 text-center">
                        <span class="text-main-600 fw-semibold text-xl d-inline-block mb-16">Empty template</span>
                        <h3 class="mb-16 text-neutral-500">my propyl</h3>
                        <p class="text-neutral-500 mb-32">The matching file in the EduAll template is empty. This page only keeps the vendor JSP mirror complete.</p>
