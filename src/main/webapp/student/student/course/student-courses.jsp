...
<div class="row gy-4 mb-24">
    <div class="col-md-4">
        <div class="gape-student-stat-card h-100">
            <span class="text-14 text-neutral-500">Active course enrollments</span>
...
<section class="gape-student-panel bg-white rounded-10 px-24 py-24 border border-neutral-30 mb-24">
    <div class="d-flex align-items-center justify-content-between gap-16 flex-wrap mb-24">
        <div>
            <h3 class="text-20 fw-semibold text-neutral-800 mb-4">My class courses</h3>
    ...
    <div class="row gy-4">
        <c:forEach var="enrollment" items="${courseEnrollments}">
            ...
            <div class="col-xl-4 col-md-6">
                <article class="gape-student-card gape-student-card--actionable h-100 overflow-hidden">
                    ...
                    <div class="gape-student-card__body px-20 py-20">
                        <div class="d-flex align-items-start justify-content-between gap-12 mb-16">
                            <span class="gape-student-icon gape-student-soft-blue text-24"><i class="ph ph-books"></i></span>
                        ...
                        <h4 class="text-18 fw-semibold text-neutral-800 mb-8"><c:out value="${course.name}"/></h4>
                        <p class="text-14 text-neutral-500 mb-16"><c:out value="${course.description}"/></p>
                        <div class="d-flex align-items-center gap-8 flex-wrap mb-18">
                            <span class="bg-neutral-20 text-neutral-600 px-10 py-6 rounded-8 text-12"><c:out value="${course.ectsLabel}"/></span>
                            <span class="bg-neutral-20 text-neutral-600 px-10 py-6 rounded-8 text-12"><c:out value="${course.subjectCountLabel}"/></span>
                            <span class="bg-neutral-20 text-neutral-600 px-10 py-6 rounded-8 text-12"><c:out value="${course.typeLabel}"/></span>
                        </div>
