...
<%
    ...
    request.setAttribute("studentPageDescription", "A student timeline with the lessons from your active class group enrollments.");
%>
...
<section class="gape-student-panel bg-white rounded-10 px-24 py-24 border border-neutral-30">
    <div class="d-flex align-items-center justify-content-between gap-16 flex-wrap mb-24">
        <div>
            ...
            <span class="text-14 text-neutral-500">A student timeline for lessons in your active class groups.</span>
        </div>
    ...
    <div class="d-flex flex-column gap-14">
        ...
        <c:if test="${empty lessons}">
            <div class="gape-student-empty text-center px-24 py-40">
                ...
                <p class="text-14 text-neutral-500 mb-0">Your student calendar is filled automatically by enrolled class group lessons.</p>
            </div>
        </c:if>
    </div>
</section>
