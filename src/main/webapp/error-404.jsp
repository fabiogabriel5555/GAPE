...
<ul class="nav-menu flex-align nav-menu--mobile">
    ...
    <li class="nav-menu__item has-submenu">
        <a href="javascript:void(0)" class="nav-menu__link">Dashboard</a>
         <ul class="nav-submenu scroll-sm">
            <li class="nav-submenu__item">
                <a href="dashboard.jsp" class="nav-submenu__link hover-bg-neutral-30"> Admin Dashbord</a>
            </li>
            <li class="nav-submenu__item">
            ...
            <li class="nav-submenu__item">
                <a href="dashboard.jsp" class="nav-submenu__link hover-bg-neutral-30">Student Admin Dashbord</a>
            </li>
            <li class="nav-submenu__item">
            ...
            <li class="nav-submenu__item">
                <a href="dashboard.jsp" class="nav-submenu__link hover-bg-neutral-30">Instructor Dashbord</a>
            </li>
            <li class="nav-submenu__item">
    ...
    <li class="nav-menu__item">
        <a href="error-404.jsp" class="nav-menu__link">Contact</a>
            ...
            <div class="header-right flex-align">
                ...
                <a href="login.jsp" class="info-action w-52 h-52 bg-main-25 hover-bg-main-600 border border-neutral-30 rounded-circle flex-center text-2xl text-neutral-500 hover-text-white hover-border-main-600">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="breadcrumb__wrapper">
                    <h1 class="breadcrumb__title display-4 fw-semibold text-center"> Pagina nao encontrada</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="bg-main-25 border border-neutral-30 rounded-16 p-40 text-center">
                        ...
                        <h3 class="mb-16 text-neutral-500">Pagina nao encontrada</h3>
                ...
                <div class="col" data-aos="fade-up" data-aos-duration="400" >
                    <div class="footer-item">
                        ...
                        <ul class="footer-menu">
                            <li class="mb-16">
                                <a href="error-404.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">About us</a>
                            </li>
                            <li class="mb-16">
                                <a href="courses.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">Courses</a>
                            </li>
                            <li class="mb-16">
                                <a href="error-404.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">Instructor</a>
                            </li>
                            <li class="mb-16">
                                <a href="error-404.jsp" class="text-neutral-500 hover-text-main-600 hover-text-decoration-underline">FAQs</a>
                            </li>
                        </ul>
                    </div>
                </div>
